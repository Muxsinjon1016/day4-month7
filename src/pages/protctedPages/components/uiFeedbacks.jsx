...
export const UiFeedbacks = ({ id, title, description, category }) => {
  ...
  return (
    <>
      <div className="bg-white h-[151px] ml-4 py-[28px] px-[32px] w-[100%] rounded-[10px]">
        return (
        <>
